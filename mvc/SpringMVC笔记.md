...
<servlet>
	...
	-->
    <load-on-startup>1</load-on-startup>转化为饿汉式，直接创建
</servlet>
<servlet-mapping>
    <servlet-name>springMVC</servlet-name>
    <!--
...
==如果不设置method属性，则不以请求方式为条件，任意请求方式都可以==

@RequestMapping注解的method属性通过请求的请求方式（get或post）匹配请求映射

@RequestMapping注解的method属性是一个RequestMethod类型的数组，表示该请求映射能够匹配多种请求方式的请求

若当前请求的请求地址==满足请求映射的value属性，但是请求方式不满足method属性==，==则浏览器报错405==：Request method 'POST' not supported
...
<img src="img/image-20211018171955852.png" alt="image-20211018171955852" style="zoom: 67%;" />
...
b>若某个拦截器的preHandle()返回了false(==根据源码得出来==)
