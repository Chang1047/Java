...
![](Docker基础篇之快速上手.assets/Snipaste_2020-10-02_17-51-22.png)
...
![](Docker基础篇之快速上手.assets/Snipaste_2020-10-02_18-14-27-16401855502441.png)
...
![](Docker基础篇之快速上手.assets/Snipaste_2020-10-02_18-18-07.png)
...
![](Docker基础篇之快速上手.assets/Snipaste_2020-10-02_18-22-04.png)
...
![](Docker基础篇之快速上手.assets/Snipaste_2020-10-02_18-30-08.png)

美团

![](Docker基础篇之快速上手.assets/Snipaste_2020-10-02_18-30-56.png)

蘑菇街

![](Docker基础篇之快速上手.assets/Snipaste_2020-10-02_18-31-11.png)
...
![](Docker基础篇之快速上手.assets/Snipaste_2020-10-02_18-46-16.png)
...
![](Docker基础篇之快速上手.assets/architecture.svg)
...
![](Docker基础篇之快速上手.assets/Snipaste_2020-10-02_19-39-12.png)
...
![](Docker基础篇之快速上手.assets/Snipaste_2020-10-02_19-48-53.png)

2、yum install -y docker-io

![](Docker基础篇之快速上手.assets/Snipaste_2020-10-02_19-49-37.png)

3、安装后的配置文件： etc/sysconfig/docker

![](Docker基础篇之快速上手.assets/Snipaste_2020-10-02_19-50-17.png)
...
![](Docker基础篇之快速上手.assets/Snipaste_2020-10-02_20-19-10.png)
...
![](Docker基础篇之快速上手.assets/Snipaste_2020-10-03_10-54-57.png)



run干了什么

![](Docker基础篇之快速上手.assets/Snipaste_2020-10-03_10-55-24.png)
...
![](Docker基础篇之快速上手.assets/Snipaste_2020-10-03_10-58-47.png)
...
![](Docker基础篇之快速上手.assets/Snipaste_2020-10-03_11-00-34.png)
...
-d:后台运行容器，并返回容器ID， 也即启动守护式容器;    是后台运行，使用docker image查看不到次容器，但是他在运行着
...
![](Docker基础篇之快速上手.assets/Snipaste_2020-10-03_11-40-34.png)
...
![](Docker基础篇之快速上手.assets/Snipaste_2020-10-03_13-23-17.png)
...
exec 是在容器中打开新的终端，并且可以启动新的进程（/bin/bash启动新的进程 进去之后再执行接下来的命令）
...
![](Docker基础篇之快速上手.assets/Snipaste_2020-10-03_13-26-40.png)



### 小总结

![](Docker基础篇之快速上手.assets/Snipaste_2020-10-03_13-30-12.png)

![](Docker基础篇之快速上手.assets/20201003133051.png)
...
![](Docker基础篇之快速上手.assets/Snipaste_2020-10-03_13-38-28.png)

平时我们安装的虚拟机的Centos都是好几个G ，为什么docker这里才要200m

![](Docker基础篇之快速上手.assets/QQ截图20201003133908.png)
...
![](Docker基础篇之快速上手.assets/Snipaste_2020-10-03_13-40-06.png)

### 分层的镜像

![](Docker基础篇之快速上手.assets/Snipaste_2020-10-03_14-02-22.png)
...
**8888:8080  8888是对外暴露的接口 8080是tomcat的默认端口**

![](Docker基础篇之快速上手.assets/Snipaste_2020-10-03_14-26-27.png)
...
![](Docker基础篇之快速上手.assets/Snipaste_2020-10-03_14-28-22.png)



3、也即当前的tomcat运行实例是一个没有文档内容的容器，以他为模板commit一个没有doc的tomcat新镜像 atguigu/tomcat02

![](Docker基础篇之快速上手.assets/Snipaste_2020-10-03_14-29-38.png)
...
==不需要在centos中mkdir 创建文件夹  直接就创建了并连接在一块==

![](Docker基础篇之快速上手.assets/Snipaste_2020-10-03_15-30-44.png)
...
![](Docker基础篇之快速上手.assets/Snipaste_2020-10-03_15-31-52.png)

容器和宿主机之间数据共享

![](Docker基础篇之快速上手.assets/Snipaste_2020-10-03_15-32-19.png)

容器停止退出后，主机修改后的数据是否同步

![](Docker基础篇之快速上手.assets/Snipaste_2020-10-03_15-33-03.png)

命令(带权限)

​	==docker run -it -v /宿主机绝对路径目录:/容器内目录**:ro** 镜像名==

​    **此命令在容器内只能读，centos中可以任何操作**

![](Docker基础篇之快速上手.assets/Snipaste_2020-10-03_15-33-49.png)
...
![](Docker基础篇之快速上手.assets/Snipaste_2020-10-03_15-35-17.png)
...
CMD echo "finished, --sucess 1"
CMD /bin/bash
```

![](Docker基础篇之快速上手.assets/Snipaste_2020-10-03_15-35-37.png)

build后生成镜像

![](Docker基础篇之快速上手.assets/Snipaste_2020-10-03_15-36-01.png)

获得一个新镜像zzyy/centos

run容器

![](Docker基础篇之快速上手.assets/Snipaste_2020-10-03_15-36-31.png)

通过上述步骤，容器内的卷目录地址已经知道，对应的主机目录在哪

![](Docker基础篇之快速上手.assets/Snipaste_2020-10-03_15-37-05.png)

**主机对应默认地址**

![](Docker基础篇之快速上手.assets/Snipaste_2020-10-03_15-37-22.png)
...
![](Docker基础篇之快速上手.assets/Snipaste_2020-10-03_15-40-46-16401856986032.png)
...
![](Docker基础篇之快速上手.assets/Snipaste_2020-10-03_15-41-51.png)

doc2/doc3 分别在dataVolumeContainer2各自新增内容

#### 回到doc1可以看到02/03各自添加的都能共享了

![](Docker基础篇之快速上手.assets/Snipaste_2020-10-03_15-42-46-16401857350413.png)

#### 删除doc1 doc2修改后doc3是否可以访问

![](Docker基础篇之快速上手.assets/Snipaste_2020-10-03_15-43-31.png)

#### 删除doc02后doc3是否访问

![](Docker基础篇之快速上手.assets/Snipaste_2020-10-03_15-43-57.png)

在进一步

![](Docker基础篇之快速上手.assets/Snipaste_2020-10-03_15-44-11.png)

#### 新建doc04继承doc03 然后删除doc03

![](Docker基础篇之快速上手.assets/Snipaste_2020-10-03_15-44-56.png)
...
![](Docker基础篇之快速上手.assets/Snipaste_2020-10-03_17-32-12.png)
...
![](Docker基础篇之快速上手.assets/Snipaste_2020-10-03_17-35-08.png)
...
![](Docker基础篇之快速上手.assets/Snipaste_2020-10-03_17-47-58.png)

小总结

![](Docker基础篇之快速上手.assets/Snipaste_2020-10-03_17-48-16.png)
...
![](Docker基础篇之快速上手.assets/Snipaste_2020-10-03_17-52-43.png)
...
![](Docker基础篇之快速上手.assets/Snipaste_2020-10-03_17-53-44.png)

准备Dockerfile文件

myCentOS内容Dockerfile

![](Docker基础篇之快速上手.assets/Snipaste_2020-10-03_17-54-40.png)
...
![](Docker基础篇之快速上手.assets/Snipaste_2020-10-03_17-56-15.png)

#### 3、运行

docker run -it 新镜像名字:TAG 

![](Docker基础篇之快速上手.assets/Snipaste_2020-10-03_17-57-09.png)
...
![](Docker基础篇之快速上手.assets/Snipaste_2020-10-03_18-02-41.png)

制作CMD版可以查询IP信息的容器

![](Docker基础篇之快速上手.assets/Snipaste_2020-10-03_18-03-11.png)
...
![](Docker基础篇之快速上手.assets/Snipaste_2020-10-03_18-05-28.png)
...
![](Docker基础篇之快速上手.assets/Snipaste_2020-10-03_18-12-29.png)

##### 5、构建

默认去改路径下找Dockerfile文件   因为创建的就是这个名字 就不用写Dockerfile

![](Docker基础篇之快速上手.assets/Snipaste_2020-10-03_18-12-48.png)

构建完成

![](Docker基础篇之快速上手.assets/Snipaste_2020-10-03_18-13-20.png)
...
![](Docker基础篇之快速上手.assets/Snipaste_2020-10-03_18-14-42.png)
...
![](Docker基础篇之快速上手.assets/Snipaste_2020-10-03_18-58-14.png)

##### 8、综合前 述容器卷测试的web服务test发布

![](Docker基础篇之快速上手.assets/Snipaste_2020-10-03_18-58-56.png)
...
![](Docker基础篇之快速上手.assets/Snipaste_2020-10-03_19-00-48.png)
...
![](Docker基础篇之快速上手.assets/Snipaste_2020-10-04_11-38-56.png)

#### 从 docker hub(阿里云加速器)拉取mysql镜像到本地标签为5.6

![](Docker基础篇之快速上手.assets/Snipaste_2020-10-04_11-40-13.png)
...
![](Docker基础篇之快速上手.assets/Snipaste_2020-10-04_11-59-32.png)

#### 数据备份测试

![](Docker基础篇之快速上手.assets/Snipaste_2020-10-04_12-02-59.png)
...
![](Docker基础篇之快速上手.assets/Snipaste_2020-10-04_12-05-08.png)
...
![](Docker基础篇之快速上手.assets/Snipaste_2020-10-04_12-28-49.png)

#### 测试持久化文件生成

![](Docker基础篇之快速上手.assets/Snipaste_2020-10-04_12-29-12.png)
...
![](Docker基础篇之快速上手.assets/Snipaste_2020-10-04_12-50-48.png)
...
![](Docker基础篇之快速上手.assets/Snipaste_2020-10-04_12-51-52.png)
...
![](Docker基础篇之快速上手.assets/Snipaste_2020-10-04_12-53-02.png)

#### 3、创建镜像仓库

![](Docker基础篇之快速上手.assets/Snipaste_2020-10-04_12-54-07.png)
...
![](Docker基础篇之快速上手.assets/Snipaste_2020-10-04_12-56-10.png)

#### 5、公有云可以查询得到

![](Docker基础篇之快速上手.assets/Snipaste_2020-10-04_12-56-53.png)

#### 6、查看详情

![](Docker基础篇之快速上手.assets/Snipaste_2020-10-04_12-57-23.png)



### 将阿里云上的镜像下载到本地

![](Docker基础篇之快速上手.assets/Snipaste_2020-10-04_12-59-00.png)
